...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference("Station.count") do
      post stations_url, params: { station: { address: @station.address, name: @station.name, review_id: @station.review_id, user_id: @station.user_id } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { address: @station.address, name: @station.name, review_id: @station.review_id, user_id: @station.user_id } }
